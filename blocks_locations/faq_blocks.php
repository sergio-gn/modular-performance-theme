        ...
        if ($use_global_faq && in_array('use_global', $use_global_faq)): ?>
            <?php if (have_rows('repeater_faq_global', 'option')): ?>
                <?php while (have_rows('repeater_faq_global', 'option')): the_row();
                    ...
                    $question = str_replace(['[Location]', '[location]', '[LOCATION]'], $suburbName, $question);
                    $answer = get_sub_field('answer');
                    $answer = str_replace(['[Location]', '[location]', '[LOCATION]'], $suburbName, $answer);
                ?>
                    <div class="a-container">
                        <p class="a-btn"><?php echo $question ?><span></span></p>
                        <div class="a-panel">
                            <p><?php echo $answer ?></p>
                        </div>
                    </div>
